...
using LatihanSerenity.Administration;
using LatihanSerenity.Administration.Entities;
using LatihanSerenity.Administration.Repositories;
using LatihanSerenity.Common;
using Serenity;
using Serenity.Data;
...
namespace LatihanSerenity.Membership.Pages
{
